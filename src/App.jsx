    ...
    <div className="relative min-h-screen bg-black">
      ...
      <section className='relative z-10 text-amber-50 h-[80vh] pt-16 flex flex-col items-center justify-center text-center px-4'>
        ...
        <form onSubmit={handleSearch} className='relative'>
          <input id='temp1' value={searchQuery} onChange={(event) => setSearchQuery(event.target.value)} className='min-w-md h-12 my-4 px-6 bg-amber-50 text-black  rounded-4xl focus:outline-none placeholder:text-center placeholder:pr-18' placeholder="Search through thousands of movies" type="text"></input>
