...
export const TMDB_MULTI_SEARCH_URL = 
  'https://api.themoviedb.org/3/search/multi'

export const TMDB_MOVIE_SEARCH_URL = 
  'https://api.themoviedb.org/3/search/movie'

export const TMDB_TV_SEARCH_URL = 
  'https://api.themoviedb.org/3/search/tv'

export const TMDB_PEOPLE_SEARCH_URL = 
  'https://api.themoviedb.org/3/search/person'

export const TMDB_COMPANY_SEARCH_URL = 
  'https://api.themoviedb.org/3/search/company'

export const TMDB_COLLECTION_SEARCH_URL = 
...
export const TMDB_POPULAR_TV_URL = 
  'https://api.themoviedb.org/3/tv/popular'
export const TMDB_AIRING_TODAY_TV_URL = 
  'https://api.themoviedb.org/3/tv/airing_today'

export const TMDB_TOP_RATED_TV_URL = 
  'https://api.themoviedb.org/3/tv/top_rated'

export const TMDB_ON_THE_AIR_TV_URL = 
