import { TMDB_MULTI_SEARCH_URL, TMDB_MOVIE_SEARCH_URL, TMDB_TV_SEARCH_URL,TMDB_PEOPLE_SEARCH_URL,TMDB_COMPANY_SEARCH_URL, TMDB_COLLECTION_SEARCH_URL, API_OPTIONS as options } from '../API/Url.jsx';
