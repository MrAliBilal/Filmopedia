...
const IndexFooter = () => {
    return (
        <footer className="mt-12">
            ...
            <div className="w-full max-w-screen-xl mx-auto p-4 sm:p-8 my-4 sm:my-8 text-white">
                ...
                <div className='px-4 sm:px-0'><hr className="my-6 border-default text-gray-300 sm:mx-auto lg:my-8" /></div>
                <span className=" block text-sm font-medium text-center">Designed & Developed by <a href="https://alibilal.online/" className="font-[Sora] tracking-wider font-bold hover:underline hover:text-secondary-color-2-500">Ali Bilal</a></span>
