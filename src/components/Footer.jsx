const Footer = ({textColor}) => {
  return (
    ...
    <div className ="w-full max-w-screen-xl mx-auto p-4 md:py-8">
        ...
        <span className ="block text-sm text-body sm:text-center">© 2025 <a href="/" className ="hover:underline hover:text-secondary-color-2-500">Filmopedia</a>. All Rights Reserved.</span>
    </div>
</footer>
  )
}
