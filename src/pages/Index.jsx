                ...
                <section className='flex justify-center mb-20'>
                    <div className='relative z-10 flex flex-col'>
                        <section className='text-white flex m-2 gap-10 justify-center'>
                            <h1 className={`m-1 cursor-pointer ${moviesSectionSwitch === 1 ? "text-secondary-color-2-500 underline underline-offset-4" : ""}`}
                                onClick={() => setmoviesSectionSwitch(1)}>
                                Movies
                            </h1>

                            <h1 className={`m-1 cursor-pointer ${moviesSectionSwitch === 2 ? "text-secondary-color-2-500 underline underline-offset-4" : ""}`}
                                onClick={() => setmoviesSectionSwitch(2)}>
                                Anime
                            </h1>

                            <h1 className={`m-1 cursor-pointer ${moviesSectionSwitch === 3 ? "text-secondary-color-2-500 underline underline-offset-4" : ""}`}
